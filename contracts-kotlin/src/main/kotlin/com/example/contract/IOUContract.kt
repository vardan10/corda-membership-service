...
class IOUContract : Contract {
    ...
    override fun verify(tx: LedgerTransaction) {
        ...
        requireThat {
            ...
            val refrenceState = tx.referenceInputRefsOfType<MembershipState<*>>().single().state.data
            "Membership status must be active." using (refrenceState.status == MembershipStatus.ACTIVE)
