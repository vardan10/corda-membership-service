...
object ExampleFlow {
    ...
    class Initiator(val iouValue: Int,
        ...
        override fun call(): SignedTransaction {
            ...
            val membershipState = serviceHub.vaultService.queryBy(MembershipState::class.java).states.singleOrNull()
            if (membershipState == null){
                throw Exception("Could not get membership state")
            }
            ...
            val txBuilder = TransactionBuilder(notary)
                    ...
                    .addReferenceState(ReferencedStateAndRef(membershipState))
